 ...
 * @license MIT
 */
define(["skylark-widgets-base/mixins/TextMixin","./buttons","./Button"],function(t,o,e){"use strict";var i=e.inherit({_construct:function(t){e.prototype._construct.call(this,t);var o=this.getSkin();this._elm.style.color=o.textColor,this._elm.style.display="flex",this._buildText(),this.setColor(o.buttonColor,o.buttonOverColor)},...t});return o.ButtonText=i});
//# sourceMappingURL=sourcemaps/ButtonText.js.map
